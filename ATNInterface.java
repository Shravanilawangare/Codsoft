...
class BankAccount {
    ...
    public void deposit(int amount){
        ...
        System.out.println("Invalid entry! Please choose a number 0");
        }
    }
    ...
    public void run(){
        ...
        do{
            ...
            switch(option){
                ...
                break;
            default:
            System.out.println("Invalid entry!! Enter only given option");
            }
        }while (option!=4);
            sc.close();
        ;
...
public class ATMInterface{
    public static void main(String[] args) {
        Scanner sc=new Scanner(System.in);
        BankAccount userAccount=new BankAccount(40000);
